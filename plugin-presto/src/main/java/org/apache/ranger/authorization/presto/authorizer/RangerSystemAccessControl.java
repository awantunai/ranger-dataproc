...
public class RangerSystemAccessControl
    ...
    public void checkCanCreateTable(SystemSecurityContext context, CatalogSchemaTableName table) {
        if (!hasPermission(createResource(table), context, PrestoAccessType.CREATE)) {
    ...
    public void checkCanCreateView(SystemSecurityContext context, CatalogSchemaTableName view) {
        if (!hasPermission(createResource(view), context, PrestoAccessType.CREATE)) {
    ...
    public void checkCanCreateViewWithSelectFromColumns(SystemSecurityContext context, CatalogSchemaTableName table, Set<String> columns) {
        for (RangerPrestoResource res : createResource(table, columns)) {
            if (!hasPermission(res, context, PrestoAccessType.CREATE)) {
    ...
    public void checkCanSetCatalogSessionProperty(SystemSecurityContext context, String catalogName, String propertyName) {
        if (!hasPermission(createCatalogSessionResource(catalogName,propertyName), context, PrestoAccessType.ALTER)) {
            LOG.info("==> RangerSystemAccessControl.checkCanSetCatalogSessionProperty(" + catalogName +"," + propertyName + ") denied");
    ...
    public void checkCanShowCreateTable(SystemSecurityContext context, CatalogSchemaTableName table) {
        if (!hasPermission(createResource(table), context, PrestoAccessType.SHOW)) {
            LOG.debug("RangerSystemAccessControl.checkCanShowCreateTable(" + table.toString() + ") denied");
    ...
    public void checkCanGrantExecuteFunctionPrivilege(SystemSecurityContext context, String functionName, PrestoPrincipal grantee, boolean grantOption) {
        if (!hasPermission(createFunctionResource(functionName), context, PrestoAccessType.GRANT)) {
            LOG.debug("RangerSystemAccessControl.checkCanGrantExecuteFunctionPrivilege(" + functionName + ") denied");
